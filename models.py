...
class Enemy:
    ...
    def get_info(self) -> str:
        ''' Выводит информацию о противнике. 
        '''
        return f'Уρ᧐ʙᥱнь пρ᧐ᴛᥙʙнᥙκα {self.level}, ᥱᴦ᧐ жᥙɜнᥙ {self.lives} '
...
class Player:
    ...
    def get_info(self) -> str:
        ...
        '''
        return f'Иʍя ᥙᴦρ᧐κα: {self.name}. Жᥙɜнᥙ ᥙᴦρ᧐κα {self.lives}.'
    ...
    def attack(self, enemy_obj):
        ...
        if fight_results == 0:
            print('''
                               ...
                               +~~~~~~~~+
            ''')
            print("ᙅτσρσʜы ʜϱ ʒαχστϱ᧘υ сραжατься!") 
            ...
            print('''
                         ...
                         +~~~~~~~~~~~~~~~~~~~~~+
            ''')
            print("Ɓы ʏҕили вᴘᴀжᴇскоrо пᴇᴘсонᴀжᴀ! Ɓᴀωᴀ ᴀтᴀкᴀ поҕᴇдилᴀ!")
            self.score += 1
            ...
            print('''
                        ...
                        +~~~~~~~~~~~~~~~~~~~~~~+
            ''')
            print('''Вραжᥱᥴᥴκᥙᥔ ηᥱρᥴ᧐нαж ᥴʍ᧐ᴦ ᥴдᥱρжαᴛь ʙαɯᥱ нαᥴᴛуη᧘ᥱнᥙᥱ!
             Зαщᥙᴛα ʙραᴦα η᧐δᥱдᥙ᧘α!
            ''')
        print('+' + '-' * 77 + '+')
    ...
    def defence(self, enemy_obj):
        ...
        if fight_results == 0:
            ...
            print('''
                    ...
                    +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
            ''')
            print("Ɓᴀω пᴇᴘсонᴀж пᴀл в ҕою. Атᴀкᴀ вᴘᴀrᴀ поҕᴇдилᴀ!")
            self.decrease_lives()
        else:
            print('''
                        +~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
                        ...
                        +~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
            ''')
            print('Ɓы ᴄʍᴏᴦᴧи ᴏᴛᴄᴛᴏяᴛь нᴀᴄᴛуᴨᴧᴇниᴇ ʙᴩᴀᴦᴀ!')
            self.score += 1
        print('+' + '-' * 77 + '+')
